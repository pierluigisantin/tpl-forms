  ...
  it: {
    translation: {
      labels: {
        ...
        introdescrizione:"Spiega in modo chiaro e completo perché la sanzione viene contestata. Tpl Fvg e le aziende consorziate effettueranno tutte le verifiche necessarie per ricostruire l’evento: orari di convalida, tracciati satellitari, dati dei dispositivi contapasseggeri, orari dei controlli, immagini registrate a bordo dei bus. Presenta ricorso solo se ci sono motivazioni oggettive e documentabili a supporto della richiesta. Se il ricorso viene respinto, potrà essere richiesto il pagamento della sanzione nella misura massima di 210,00 euro, oltre al costo del biglietto e alle eventuali spese di procedimento. Fai clic qui per maggiori informazioni. <a href='https://tplfvg.it/it/sanzioni/normesanzioni'> link </a>",
