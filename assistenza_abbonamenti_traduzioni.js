const resources = {
  it: {
    translation: {
      labels: {
        legendanagrafica: "ASSISTENZA ABBONAMENTI SCOLASTICI E FORMULA FAMIGLIA",
        introtiposoggetto: "Compila i dati indicando, se possibile, l'indirizzo di posta elettronica associato all'account di Tpl Fvg da cui intendi richiedere o hai già richiesto l'agevolazione per l'abbonamento scolastico o per il nucleo familiare.",
  ...
  en: {
    translation: {
      labels: {
        legendanagrafica: "ASSISTANCE FOR SCHOOL PASSES AND FAMILY DISCOUNT (FORMULA FAMIGLIA)",
        introtiposoggetto: "Please fill in the form using, where possible, the e-mail address linked to the Tpl Fvg account from which you intend to request, or have already requested, the school pass discount or the family discount (Formula Famiglia).",
        erroreCampoObbligatorio: "",
        ...
        accountTpl: "Reference Province",
        descrizione: "Describe your request",
        introdescrizione: "Before describing your request, please provide: the student's first name and last name, their Italian tax code, the Tpl Fvg personal pass ID number (if already available) and the type of pass concerned. Then describe clearly and briefly the reason why you are asking for assistance.",
      ...
      tooltips: {
        ...
        accountTpl: "Enter the name of the Tpl Fvg consortium company that operates the line or service concerned by your request. If you don't know it, select Tpl Fvg.",
        ultimo: ""
      }
    }
  }
